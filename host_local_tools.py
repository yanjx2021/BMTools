...
server.load_tool("stable_diffusion")
server.load_tool("bark")
server.load_tool("prompt_generator")
server.load_tool("text_to_video")
server.load_tool("image_captioning")
server.load_tool("document_qa")
server.serve()